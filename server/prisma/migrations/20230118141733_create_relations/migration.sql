/*
  ...
  - You are about to drop the column `completed` on the `day_habits` table. All the data in the column will be lost.
  - You are about to drop the column `created_at` on the `day_habits` table. All the data in the column will be lost.
  - You are about to drop the column `updated_at` on the `day_habits` table. All the data in the column will be lost.
